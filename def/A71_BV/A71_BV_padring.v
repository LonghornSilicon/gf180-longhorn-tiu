module A71_BV_padring (
  ...
  gf180mcu_fd_io__in_s W13 (.PU(W13_PU), .PD(W13_PD), .Y(W13_Y), .PAD(W13), .VSS(W12), .DVSS(W12), .VDD(N01), .DVDD(N01));
  gf180mcu_fd_io__in_c W14 (.PU(W14_PU), .PD(W14_PD), .Y(W14_Y), .PAD(W14), .VSS(W12), .DVSS(W12), .VDD(N01), .DVDD(N01));
  gf180mcu_fd_io__in_c W15 (.PU(W15_PU), .PD(W15_PD), .Y(W15_Y), .PAD(W15), .VSS(W12), .DVSS(W12), .VDD(N01), .DVDD(N01));
  gf180mcu_fd_io__in_c W16 (.PU(W16_PU), .PD(W16_PD), .Y(W16_Y), .PAD(W16), .VSS(W12), .DVSS(W12), .VDD(N01), .DVDD(N01));
  gf180mcu_fd_io__in_c W17 (.PU(W17_PU), .PD(W17_PD), .Y(W17_Y), .PAD(W17), .VSS(W12), .DVSS(W12), .VDD(N01), .DVDD(N01));
  gf180mcu_fd_io__bi_t W18 (.CS(W18_CS), .SL(W18_SL), .IE(W18_IE), .OE(W18_OE), .PU(W18_PU), .PD(W18_PD), .A(W18_A), .PDRV0(W18_PDRV0), .PDRV1(W18_PDRV1), .Y(W18_Y), .PAD(W18), .VSS(W12), .DVSS(W12), .VDD(N01), .DVDD(N01));
  gf180mcu_fd_io__bi_t W19 (.CS(W19_CS), .SL(W19_SL), .IE(W19_IE), .OE(W19_OE), .PU(W19_PU), .PD(W19_PD), .A(W19_A), .PDRV0(W19_PDRV0), .PDRV1(W19_PDRV1), .Y(W19_Y), .PAD(W19), .VSS(W12), .DVSS(W12), .VDD(N01), .DVDD(N01));
  gf180mcu_fd_io__bi_t W20 (.CS(W20_CS), .SL(W20_SL), .IE(W20_IE), .OE(W20_OE), .PU(W20_PU), .PD(W20_PD), .A(W20_A), .PDRV0(W20_PDRV0), .PDRV1(W20_PDRV1), .Y(W20_Y), .PAD(W20), .VSS(W12), .DVSS(W12), .VDD(N01), .DVDD(N01));
  gf180mcu_fd_io__bi_t W21 (.CS(W21_CS), .SL(W21_SL), .IE(W21_IE), .OE(W21_OE), .PU(W21_PU), .PD(W21_PD), .A(W21_A), .PDRV0(W21_PDRV0), .PDRV1(W21_PDRV1), .Y(W21_Y), .PAD(W21), .VSS(W12), .DVSS(W12), .VDD(N01), .DVDD(N01));
  gf180mcu_fd_io__bi_t W22 (.CS(W22_CS), .SL(W22_SL), .IE(W22_IE), .OE(W22_OE), .PU(W22_PU), .PD(W22_PD), .A(W22_A), .PDRV0(W22_PDRV0), .PDRV1(W22_PDRV1), .Y(W22_Y), .PAD(W22), .VSS(W12), .DVSS(W12), .VDD(N01), .DVDD(N01));
